...
// Compound index for efficient queries - allow multiple votes per market (one per meme)
userVoteSchema.index({ userAddress: 1, marketId: 1, memeCid: 1 }, { unique: true });
